        ...
        child: Scaffold(
          ...
          child: SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  // Text-only: the 300x300 album art block is gone. A single
                  // hairline divider marks the top of the player instead, so
                  // the title block reads as the first thing on the screen.
